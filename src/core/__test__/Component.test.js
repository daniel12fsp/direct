...
describe("Component lifecycle", ()=> {
    ...
    it("null vs Component", () => {
        ...
        const methods = ["constructor", "componentWillMount", "render","componentDidMount"]
    ...
    it("With props diff: Component  vs Component", () => {
        ...
        expect(p(root.innerHTML)).toBe(answear);
        update( <PropsCompoment status="str1"/>, <PropsCompoment status="str2"/>, root);
    ...
    it("With props diff: Component1  vs Component2", () => {
        ...
        update(null, <PropsCompoment status="str1"/>, root);
        expect(p(root.innerHTML)).toBe(answear);
        update( <PropsCompoment status="str1"/>, <DumbCompoment beSmart={false}/>, root);
    ...
    it("Component1  vs 2-level Component2", () => {
        ...
        update(null, <PropsCompoment status="str1"/>, root);
        expect(p(root.innerHTML)).toBe(answear);
        update( <PropsCompoment status="str1"/>, <TwoLevelCompoment status="cool"/>, root);
    ...
    it("2-level Component1  vs 2-level Component1", () => {
        ...
        expect(p(root.innerHTML)).toBe(answear);
        update( <TwoLevelCompoment status="cool"/>, <TwoLevelCompoment status="coolest"/>, root);
